(ns introai.assignment4.run-game
  (:gen-class)
  (:require
    [introai.assignment4.agents.game-funcs :refer [all-agents-term? agent-term?]]
    [introai.assignment4.agents.agent :refer [gen-agent]]
    [clojure.core.strint :refer [<<]]
    [nano-id.core :refer [nano-id]]
    [clojure.tools.cli :refer [parse-opts]]
    [introai.assignment4.read-bayes :refer [read-graph-from-file]]
    [introai.assignment4.bayes-network :refer [gen-b-net-t-0]]
