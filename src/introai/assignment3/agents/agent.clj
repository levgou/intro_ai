(ns introai.assignment3.agents.agent
  (:gen-class)
  (:require
    [introai.assignment3.agents.human :refer [interactive]]
    [introai.assignment3.agents.greedy :refer [greedy]]
    [introai.assignment3.agents.min-max :refer [min-max]]
    [introai.assignment3.agents.max-max :refer [max-max]]
    [introai.assignment3.agents.game-funcs :refer
